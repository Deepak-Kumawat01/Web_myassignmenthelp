...
//               <div className="text-green-700 text-xl">👁️</div>
...
//             </div>
//             <div className="bg-[#0c1c33] text-white px-6 py-3 rounded-md flex items-center gap-3">
//               ⭐ <span className="font-semibold">Site Jabber</span>
//             </div>
//             <div className="bg-[#0c1c33] text-white px-6 py-3 rounded-md flex items-center gap-3">
//               ⭐ <span className="font-semibold">MAH Reviews</span>
//             </div>
//           </div>
//         </div>
  ...
  return (
    <section className="bg-white py-12">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12">
        ...
        <div className="bg-white shadow-lg rounded-md border border-gray-200">
          {/* TOP DARK BLUE HEADING */}
          <div className="bg-[#0d1f42] text-xl text-white text-center py-3 rounded-t-md font-semibold">
